...
class Control(object):
	...
	def make_obstacles(self):
		...
		walls = [Block(pg.Color("chocolate"), (0,912,1488,16)),
				 Block(pg.Color("chocolate"), (0,0,16,1536)),
				Block(pg.Color("chocolate"), (1552,0,20,912)),
				Block(pg.Color("chocolate"), (16,752,1216,16)),
				]
		static = [
				Block(pg.Color("chocolate"), (1024,576,32,176)),
				  Block(pg.Color("chocolate"), (768,544,32,208)),
				  Block(pg.Color("chocolate"), (800,688,64,16)),
				  Block(pg.Color("chocolate"), (832,624,64,16)),
				  Block(pg.Color("chocolate"), (864,576,64,16)),
				  Block(pg.Color("chocolate"), (496,304,32,448)),
				  Block(pg.Color("chocolate"), (64,192,256,16)),
				  Block(pg.Color("chocolate"), (448,192,112,16)),
				  Block(pg.Color("chocolate"), (656,192,16,240)),
				  Block(pg.Color("chocolate"), (928,192,32,480)),
				  Block(pg.Color("chocolate"), (656,416,176,16)),
				  Block(pg.Color("chocolate"), (864,416,272,16)),
				  Block(pg.Color("chocolate"), (704,192,16,16)),
				  Block(pg.Color("chocolate"), (816,192,16,16)),
